...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void initState() {
    super.initState();
    logger.i('App: DashboardPage initialized. Prefetching data...');
  ...
  void _selectProduct(Product product) {
    logger.d('Product: Selected ${product.name} (ID: ${product.id})');
    setState(() {
  ...
  void _closeProductDetail() {
    logger.d('Product: Closing detail view');
    setState(() {
  ...
  void _showProfileOverlay(ProfileOverlay type) {
    ...
    if (type == ProfileOverlay.settings) {
      logger.d('UI: Opening Settings');
      page = SettingsPage(onClose: () => Navigator.of(context).pop());
    } else {
      logger.d('UI: Opening FAQ');
          ...
          IndexedStack(
            ...
            children: [
              MainPage(
                ...
                onSearchChanged: (q) {},
                onSearchSubmitted: () => _onTabSelected(1),
            ...
            child: IgnorePointer(
              ...
              child: AnimatedOpacity(
                ...
                child: ChatOverlay(
                  ...
                  toggleChat: () {
                    logger.d('Chat: Toggle (Open: ${!_isChatOpen})');
