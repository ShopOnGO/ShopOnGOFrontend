class ApiConfig {
  ...
  static const String productsEndpoint = '$_productBaseUrl/product-service/products/';

  static const String favoritesEndpoint = '$_favoritesBaseUrl/favorites-service/';
