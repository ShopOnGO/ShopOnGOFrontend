...
class _AddProductDialogState extends State<AddProductDialog> {
  ...
  final _dimensionsController = TextEditingController(text: "50x35x4 см");
  ...
  Future<void> _submit() async {
    ...
    if (_selectedFileBytes == null || _selectedFileName == null) {
      NotificationHelper.show(context, message: "Выберите изображение товара", isError: true);
      return;
    }
    ...
    try {
      ...
      logger.d("AddProduct: Final Payload: ${jsonEncode(productData)}");
      ...
      if (!mounted) return;
      NotificationHelper.show(context, message: e.toString(), isError: true);
    } finally {
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text("Добавить новый товар", style: theme.textTheme.headlineSmall),
                              ...
                              child: _selectedFileBytes != null
                                  ...
                                  : const Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 8),
                                        Text("Фото товара", textAlign: TextAlign.center),
                                      ],
                                    ),
                            ),
                          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              TextFormField(
                                ...
                                decoration: _buildDecoration("Название", Icons.shopping_bag_outlined),
                              ...
                              _isLoadingBrands 
                                ...
                                : DropdownButtonFormField<int>(
                                    ...
                                    isExpanded: true,
                                    decoration: _buildDecoration("Бренд", Icons.business_outlined),
                    ...
                    Text("Характеристики и Вариант", style: theme.textTheme.titleMedium),
                      ...
                      children: [
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: _buildDecoration("Материал", Icons.layers_outlined),
                          ),
                        ),
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: _buildDecoration("Артикул (SKU)", Icons.tag),
                      ...
                      children: [
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: _buildDecoration("Цена (BYN)", Icons.payments_outlined),
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            keyboardType: TextInputType.number,
                            decoration: _buildDecoration("Остаток (шт)", Icons.inventory_2_outlined),
                            validator: (v) => v!.isEmpty ? "Укажите кол-во" : null,
                          ),
                        ),
                      ],
                    ),
                      ...
                      children: [
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: _buildDecoration("Цвет", Icons.palette_outlined),
                          ),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: _buildDecoration("Размер", Icons.straighten_outlined),
                          ),
                        ),
                      ],
                    ),
                    ...
                    TextFormField(
                      ...
                      decoration: _buildDecoration("Габариты упаковки", Icons.aspect_ratio_outlined),
                    ),
                    const SizedBox(height: 12),
                    ...
                    TextFormField(
                      ...
                      maxLines: 3,
                      decoration: _buildDecoration("Описание товара", Icons.description_outlined),
